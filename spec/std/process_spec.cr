...
describe Process do
  ...
  it "getuid" do
    Process.uid.should eq `id -u`.to_i
    Process.uid.should eq Process.euid
  end

  it "getgid" do
    Process.gid.should eq `id -g`.to_i
    Process.gid.should eq Process.egid
  end
